...
function Stared() {
  return (
    <section className="container px-2 py-8 sm:py-14 md:py-20 space-y-[15px] md:space-y-[23px] text-center">
      <p className="text-[20px] text-primary font-montserrat">GET STARTED</p>
      <h1 className="text-3xl sm:text-[36px] italic font-montserrat text-white font-medium leading-[40px]">
        Embrace <span className="font-bold not-italic">the new era of</span>{" "}
        outbound.
      </h1>
      <p className="text-base sm:text-[20px] text-white/50 max-w-[550px] mx-auto font-workSans">
